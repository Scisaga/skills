...
DEVOPS_ROOT="$(cd "${COMMON_LIB_DIR}/../../.." && pwd)"
DEVOPS_SCRIPTS_ROOT="${DEVOPS_ROOT}/scripts"
DEVOPS_ASSETS_ROOT="${DEVOPS_ROOT}/assets"
...
service_assets_dir() {
  ...
  printf '%s\n' "${DEVOPS_ASSETS_ROOT}/services/${service_name}"
}
...
This script reads configuration from the target service asset directory:
  - .env
  - .env.local
