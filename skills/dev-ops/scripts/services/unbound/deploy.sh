...
seed_local_file "${SERVICE_ASSETS_DIR}/local-records.conf.example" "${SERVICE_ASSETS_DIR}/local-records.conf"
seed_local_file "${SERVICE_ASSETS_DIR}/forward-zones.conf.example" "${SERVICE_ASSETS_DIR}/forward-zones.conf"

run_compose_stack "${SERVICE_ASSETS_DIR}" "unbound.yaml"
